...
namespace GLApp
{
    ...
    void Framebuffer::setup(const char *vertShader, const char *fragShader, size_t windowWidth, size_t windowHeight)
    {
        ...
        screenShader.init(vertShader, fragShader);
        screenShader.use();
        screenShader.setInt("screen_texture", 0);
        screenShader.setInt("depth_texture", 1);
